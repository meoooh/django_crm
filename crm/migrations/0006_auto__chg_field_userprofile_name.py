...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('crm_userprofile', 'name', self.gf('django.db.models.fields.CharField')(max_length=70, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.name'
        db.alter_column('crm_userprofile', 'name', self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2013, 5, 11, 0, 0), max_length=70))
    ...
    models = {
        ...
        'crm.userprofile': {
            ...
            'mobile': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20', 'blank': 'True'}),
