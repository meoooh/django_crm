...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Board.writer'
        db.add_column('crm_board', 'writer',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=datetime.datetime(2013, 5, 16, 0, 0), to=orm['auth.User'], to_field='username', unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Board.writer'
        db.delete_column('crm_board', 'writer_id')
