...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('crm_board', (
            ...
            ('writer', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], to_field='username', unique=True)),
            ...
            ('notImg', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
