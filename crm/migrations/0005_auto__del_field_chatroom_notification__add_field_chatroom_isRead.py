...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ChatRoom.notification'
        db.delete_column('crm_chatroom', 'notification')

        # Adding field 'ChatRoom.isRead'
        db.add_column('crm_chatroom', 'isRead',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ChatRoom.notification'
        db.add_column('crm_chatroom', 'notification',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ChatRoom.isRead'
        db.delete_column('crm_chatroom', 'isRead')
