...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Board.writer'
        raise RuntimeError("Cannot reverse this migration. 'Board.writer' and its values cannot be restored.")
