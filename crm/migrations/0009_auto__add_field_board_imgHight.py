...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Board.imgHight'
        db.add_column('crm_board', 'imgHight',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Board.imgHight'
        db.delete_column('crm_board', 'imgHight')
    ...
    models = {
        ...
        'crm.board': {
            ...
            'imgHight': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'notImg': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
