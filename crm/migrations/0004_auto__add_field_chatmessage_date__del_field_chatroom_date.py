...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChatMessage.date'
        db.add_column('crm_chatmessage', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 5, 4, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'ChatRoom.date'
        db.delete_column('crm_chatroom', 'date')


    def backwards(self, orm):
        # Deleting field 'ChatMessage.date'
        db.delete_column('crm_chatmessage', 'date')

        # Adding field 'ChatRoom.date'
        db.add_column('crm_chatroom', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 5, 4, 0, 0), blank=True),
                      keep_default=False)
