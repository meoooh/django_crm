...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('crm_userprofile', 'mobile', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.mobile'
        db.alter_column('crm_userprofile', 'mobile', self.gf('django.db.models.fields.CharField')(default='', max_length=20, unique=True))
