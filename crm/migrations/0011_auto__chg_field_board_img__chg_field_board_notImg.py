...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Board.img'
        db.alter_column('crm_board', 'img', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Board.notImg'
        db.alter_column('crm_board', 'notImg', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Board.img'
        raise RuntimeError("Cannot reverse this migration. 'Board.img' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Board.notImg'
        raise RuntimeError("Cannot reverse this migration. 'Board.notImg' and its values cannot be restored.")
    ...
    models = {
        ...
        'crm.board': {
            ...
            'writer': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['auth.User']", 'to_field': "'username'", 'unique': 'True'})
        },
        'crm.chatmessage': {
